...
namespace Theme.Command.AttachedCommands
{
    ...
    public class EventParameters
    {
        ...
        /// <param name="e"></param>
        public EventParameters(object sender, EventArgs e)
        {
            Sender = sender;
            EventArgs = e;
        }
    ...
    public class CommandEvent : Freezable
    {
        ...
        /// <summary>
        /// CommandParameter Property Dependency Property
        /// </summary>
        ...
        private void OnEventRaised(object sender, EventArgs e)
        {
            if (Command != null)
            {
                var ep = CommandParameter != null ? CommandParameter : new EventParameters(sender, e);
    ...
    public static class EventCommander
    {
        ...
        static readonly DependencyProperty MappingsProperty =
        ...
        /// <returns></returns>
        static CommandEventCollection InternalGetMappingCollection(
